...
#                     if maxGustpast == 0 and maxGustfut == 15:
#                         print 'pause'                   
...
probNextWindHigherThan,rowCountw = corr.probNextHigherThan(nWindEventsDispl,gustmax)
probNextGustHigherThan,rowCountg = corr.probNextHigherThan(nGustEventsDispl,gustmax)
factor1 = 100
